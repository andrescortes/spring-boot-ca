package co.com.app.jpa.helper;

import co.com.app.jpa.userapp.UserDataJPARepository;
import co.com.app.jpa.userapp.UserDataJPARepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    private UserDataJPARepositoryAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new UserDataJPARepositoryAdapter(repository, objectMapper);
    }
